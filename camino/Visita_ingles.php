<?php
    //INICIAR SESION
    session_start();
    echo $nombrejesuita=$_SESSION["nombre"];
...
<html>
    ...
    <body>
        <?php
            echo "<h1>Hello, $nombrejesuita. where do you want to go?</h1>";
        ?>
        <form name="Visita" method="get" action="./css/guardarVisita_Ingles.php">
